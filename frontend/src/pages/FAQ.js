    ...
    items: [
      {
        ...
        a: 'رسوم التوصيل ثابتة وقيمتها 30.00 د.أ لجميع مناطق المملكة، وتُضاف إلى إجمالي الطلب عند إتمام الشراء.',
      },
      {
    ...
    items: [
      {
        ...
        a: 'نعم، خلال 3 أيام من الاستلام وبشرط أن يكون المنتج غير مستعمل وبتاغاته الأصلية. تُطبّق رسوم توصيل 30.00 د.أ على الشحنة البديلة إذا كان الاستبدال بسبب تغيير الرأي أو المقاس.',
      },
      {
